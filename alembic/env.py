...
target_metadata = Base.metadata # Point Alembic to your app's Base metadata
...
def run_migrations_online() -> None:
    ...
    """
    # Use the engine from app.database to ensure consistency
    # This requires app.database.engine to be configured correctly
    from app.database import engine as app_engine

    connectable = app_engine

    with connectable.connect() as connection:
        # For SQLite, batch mode is needed for certain ALTER operations
